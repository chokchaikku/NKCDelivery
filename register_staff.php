...
<form action="action_register_staff.php" method="POST" enctype="multipart/form-data">
<div class="wrapper">       
    <div class="title">
      สมัครพนักงานส่งอาหาร
    </div>
    <div class="form"> 
      ...
      <div class="inputfield">
          <label>เลขบัตรประชาชน <font color="red">*</font></label>
          <input type="text" class="input" name="card_id" required>
       </div>
  	<input type="hidden" name="size" value="1000000">
  	<div class="inputfield">
    <label>อัพโหลดรูปประจำตัว <font color="red">*</font></label>
      ...
      <div class="inputfield terms">
       ...
       <button type="submit" class="registerbtn" name="upload">สมัครพนักงานส่งอาหาร</button>
